...
export default function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <div
      className="relative w-full max-w-lg pt-10 p-6 rounded-xl border-themed bg-light shadow-themed
             transition-transform duration-300 hover:-translate-y-0.5
             grid grid-rows-[auto_auto_1fr_auto] min-h-[480px]"
    >
      <div
      ...
      {/* Title */}
      <h2 className="text-light text-xl font-semibold mb-4 leading-snug">
        {project.title}
      ...
      {/* Description (takes up flexible space so buttons align) */}
        ...
        {project.codeUrl && (
          <a
            ...
            className="inline-block px-4 py-2 bg-secondary text-light rounded font-medium 
                   ...
                   active:translate-y-0.5 active:scale-95 shadow-sm hover:shadow-md"
          >
            View Code
          </a>
        )}
